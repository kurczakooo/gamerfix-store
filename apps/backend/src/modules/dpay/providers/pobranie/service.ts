...
class DpayOnDeliveryProviderService extends AbstractPaymentProvider<Options> {
  static identifier = "dpay_pobranie";
...
export default DpayOnDeliveryProviderService;
